//program for AND gate using two variables and no. of
//iterations from user input
...
int main()
{
    int i,j,numIn=4,iterations,bias=-1,input[4][2]={{0,0},{0,1},{1,0},{1,1}},desired_out[4]={0,0,0,1};
